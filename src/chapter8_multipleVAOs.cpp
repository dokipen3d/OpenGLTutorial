...
int main() {
    ...
    auto window = []() {
        ...
        auto window = glfwCreateWindow(1280, 720, "Chapter 7 - Interleaved Data", NULL, NULL);
    ...
    const std::array<vertex2D, 3> backGroundVertices {{
        //   position   |     colour
        {{-1.f, -1.f},  {0.12f, 0.14f, 0.16f}},
        {{ 3.f, -1.f},  {0.12f, 0.14f, 0.16f}},
        {{-1.f,  3.f},  {0.80f, 0.80f, 0.82f}}
    }};

    const std::array<vertex2D, 3> foregroundVertices {{
        //   position   |     colour
